...
interface PieItem { label: string; amount: number; color: string; }
...
export function AnalyticsPage() {
  ...
  const [allBalances, setAllBalances] = useState<Map<string, number>>(new Map());
  ...
  const loadData = async () => {
    ...
    setAllBalances(calculateAllBalances(fundsData, txnsData));
  };
